...
%\input{info_kapitel/abkuerzungen}
%\input{info_kapitel/glossar}
%\input{info_kapitel/symbole}	
...
\input{kapitel/Videospiele}
\input{kapitel/Videospielentwicklung}
\input{kapitel/Entscheidungssysteme}
\input{kapitel/Suchprobleme und Suchalgorithmen}
\input{kapitel/GOAP}
\input{kapitel/State of the art}
...
%\input{info_kapitel/kapitel1} % Externe Datei einbinden
%\input{info_kapitel/kapitel2} % Externe Datei einbinden
%\input{info_kapitel/kapitel3} % Externe Datei einbinden
%\input{info_kapitel/kapitel4} % Externe Datei einbinden
...
%\input{info_kapitel/anhang-a}
%\input{info_kapitel/anhang-b}
