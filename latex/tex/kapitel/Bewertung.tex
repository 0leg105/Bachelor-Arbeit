...
Der Vergleich wird sich auf die folgenden Punkte fokussieren: Erlernbarkeit, Skalierbarkeit, Debugging, Implementation, Performance und Speicherverbrauch. 
...
Bei der Implementation wird betrachtet, wie aufwendig die Implementierung der Funktionsweise des Entscheidungssystem ist.

%FSM
Die FSM ist als Ad-Hoc-Authoring Methode ein statisches Entscheidungssystem und ist in Godot unkompliziert zu implementieren. Einen FSM Knoten zu erstellen und diesen mit Aktions Komponenten zu ergänzen ist einfach.
Doch mit der größe des Spieles steigt der Aufwand die FSM instandzuhalten, da sie viel zu unskalierbar und undynamisch ist.\autocite{review_game_ai}

Außerdem können Leistungsprobleme auftreten, insbesondere bei einer übermäßigen Anzahl von Knoten.\autocite{U2023}
