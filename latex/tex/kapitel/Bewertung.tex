...
In diesem Kapitel werden die Entscheidungssysteme Finite State Machine (FSM), Behavior Tree (BT) und Goal Oriented Action Planning (GOAP) aus der Erfahrung durch die Implementation, Benchmarks, wissenschaftlicher Literatur verglichen und bewertet.
