...
\lstdefinelanguage{Pseudo}{
	keywords={FUNKTION, WENN, SOLANGE, DANN, FUER, JEDEN, JEDE ,ENDE, NAECHSTE, NAECHSTER, VON, FUNCTION, IMPORT, END if, then, void, IMPORTIERE, OEFFENTLICH},
	morecomment=[l]{//}
}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{Videospielentwicklung/game-ai model}
