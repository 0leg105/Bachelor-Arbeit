...
%Die Umsetzung passiert auf Basis der Publikation von Jeff Orkin \autocite{}. Die Implementierung geschieht unter der Godot Engine 4.3. Das Kapitel wird zuerst die grundlegende Architektur von GOAP anhand eines Agenten beschreiben.[Kapitel weiter erläutern]
...
%\begin{figure}[h]
  %\centering
  %\includegraphics[width=16cm]{GOAP_2/GOAP UML}
...
%
%Der GoapAgent bildet dabei die Hauptklasse und fungiert als Schnittstelle zur restlichen Spielwelt. Die Spielwelt kann dem GoapAgent Informationen wie die Position des Spielers oder bestimmte Koordinaten innerhalb der Spielwelt übermitteln. Dabei erbt der GoapAgent von der Klasse Npc. Die Klasse Npc stellt Komponenten bereit, die es dem GoapAgent ermöglichen, mit der Spielwelt zu interagieren. Außerdem sollte der GoapAgent die eigentliche Aktionssequenz ausführen, welche durch den GoapPlanner gegeben wird.
%
